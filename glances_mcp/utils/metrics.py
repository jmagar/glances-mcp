...
from config.models import MetricPoint, PerformanceBaseline
...
class MetricsCalculator:
    ...
    def calculate_cpu_score(cpu_data: Dict[str, Any]) -> float:
        ...
        try:
            ...
            return max(0, usage_score - iowait_penalty)
        except Exception:
            return 0.0
    ...
    def calculate_load_score(load_data: Dict[str, Any], cpu_count: int = 1) -> float:
        ...
        try:
            ...
            if avg_load <= 0.7:
                ...
                return 100 - ((avg_load - 0.7) * 100)
            else:
                return max(0, 70 - (avg_load - 1.0) * 30)
        except Exception:
            return 0.0
