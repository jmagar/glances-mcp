...
from config.models import MetricPoint, PerformanceBaseline, GlancesServer
...
class BaselineManager:
    ...
    async def collect_metrics_sample(self, server_alias: Optional[str] = None) -> None:
    ...
    async def calculate_all_baselines(self, server_alias: Optional[str] = None) -> Dict[str, Dict[str, PerformanceBaseline]]:
    ...
    def get_baseline_summary(self) -> Dict[str, Any]:
        ...
        summary = {
            ...
            "servers_with_baselines": len(set(
